# ITERATION 5 - the v3-B ring with a BIGGER HUB. Same die and macro plan as
# iteration 4; wedge depth 380 (was 430) grows the hub square 840 -> 940 um.
# Why: iteration 4 routed into ~50k DRCs, ~31k of them metal shorts piled in
# the hub bins (drc.rpt spatial histogram 2026-08-30), ~90% among opt/CTS-
# inserted cells - LOCAL hub over-density; global route overflow was only
# 7.3% H. Pairs with ASIC_PLACE_MAX_DENSITY=0.62 (stage-03 hook).
# Sourced by 01_floorplan.tcl via ASIC_FLOORPLAN.
#
