# OpenRAM PRODUCTION macro config - 16KB cache, ASSOC=1.
#
# Data store is banked per way per line-word, so one bank = (sets x 32b) and
# sets = 1024/ASSOC. This macro is that bank: 1024 x 32, 1RW+1R, byte-masked,
# instantiated 4 times at ASSOC=1.
# deepest array: worst bitline delay - the real physics of low associativity
#
...
output_path = "macros_out/32x1024"
output_name = "openram_sram_1rw1r_32x1024_8"
