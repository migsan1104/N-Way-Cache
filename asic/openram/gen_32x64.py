# OpenRAM PRODUCTION macro config - 16KB cache, ASSOC=16.
#
# Data store is banked per way per line-word, so one bank = (sets x 32b) and
# sets = 1024/ASSOC. This macro is that bank: 64 x 32, 1RW+1R, byte-masked,
# instantiated 64 times at ASSOC=16.
# 64 instances; per-macro periphery overhead peaks here - may lose to flops
#
...
output_path = "macros_out/32x64"
output_name = "openram_sram_1rw1r_32x64_8"
