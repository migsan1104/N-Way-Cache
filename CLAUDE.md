...
a floor: post-P&R slack will be worse. Verification still defaults to 4KB (functional baseline,
capacity-independent checks; 16KB regression uses the capacity-scaled TB knobs).
